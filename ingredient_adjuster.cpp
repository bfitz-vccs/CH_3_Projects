...
int main(){
    ...
    // I am using a float for the 48 cookies per batch so that I do not run into issues with integer division from user input.
    ...
    std::cout << "Required cups of sugar: " << required_sugar << std::endl;
    std::cout << "Required cups of butter: " << required_butter << std::endl;
    std::cout << "Required cups of flour: " << required_flour << std::endl;
